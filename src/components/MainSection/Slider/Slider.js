...
import smallBg from "../../Img/Desktop/Slider/bg-sm.png";
       ...
       <div>
           <Container className="mainContainer">
                <Row>
                    ...
                    <Col xs= {12} className = "colSm d-xs-block d-sm-block d-md-none">
                        <Carousel prevIcon = {null} nextIcon = {null}> 
                            <Carousel.Item className = "carouselItem">
                                ...
                                <Carousel.Caption className = "carouselCaption">
                                    <h3 className = "titleCarousel leftCarousel">Control and manage any device with cloud solutions</h3>
                    ...
                    <Col className="secondCol">
                        <Card>
                            ...
                            <Card.Body>
                                ...
                                <form>
									<button className="styleBtnSales" formAction="https://www.facebook.com/">
