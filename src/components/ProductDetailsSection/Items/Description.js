...
// 	return (
// 		<div>
// 			<Container className="containerTab">
// 				<Row>
// 					<Col className="colTab">
// 						<Tabs defaultActiveKey="description" id="tabs" className="tabsTab">
// 							<Tab eventKey="description" title="Description" className="tabTab">
// 								<Row>
// 									<Col md={6}>
...
// 								</Row>
// 							</Tab>
// 							<Tab eventKey="information" title="Additional Information" className="tabTab">
// 								<Row>
// 									<Col md={6}>
...
// 								</Row>
// 							</Tab>
// 							<Tab eventKey="reviews" title="Reviews (3)" className="tabTab">
// 								<Row>
// 									<Col md={6}>
